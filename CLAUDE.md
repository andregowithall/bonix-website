...
- 图片文件：hero-fallback.jpeg、prod-visual.jpeg、stage1-main.jpeg、stage2-img1~4.jpeg、stage3-main.jpeg、cert-badges.jpeg、cert-doc-gmpc.jpeg、cert-doc-iso.jpeg、ingredients.png
...
- [x] 优化 Hero 图片（从 base64 改为独立图片文件）
- [ ] 补充 MOQ 信息到网站
